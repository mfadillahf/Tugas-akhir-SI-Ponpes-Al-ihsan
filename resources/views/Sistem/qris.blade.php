...
<div class="row">
    <div class="col-12">
        <div class="card shadow-sm">
            ...
            <form action="{{ route('tentang.update', $tentang->id ?? 0) }}" method="POST" enctype="multipart/form-data"
                id="formTentang" data-mode="edit" class="form-floating-outline needs-validation" novalidate>
                @csrf
                @method('PUT')

                <!-- Judul + Preview Gambar -->
                <div class="card-body text-center">
                    <h4 class="fw-bold mb-4">Edit Qris Donatur</h4>

                    <img src="{{ $tentang && $tentang->gambar ? asset('storage/app/public/tentang/' . $tentang->gambar) : asset('assets/img/placeholders/placeholder.png') }}"
                        alt="Foto Pesantren" class="rounded-3 mb-3 mx-auto d-block" id="previewTentangImg"
                        style="width: 100%; max-width: 500px; height: auto; object-fit: cover;" />

                    <div class="d-flex justify-content-center align-items-center gap-2 flex-wrap">
                        <button type="button" class="btn btn-primary mb-2"
                            onclick="document.getElementById('gambar').click()">Upload Foto Baru</button>
