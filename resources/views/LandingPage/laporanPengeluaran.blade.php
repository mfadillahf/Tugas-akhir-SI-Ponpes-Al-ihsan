        ...
        <div class="col-md-12">
          <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
              <h2 class="title">Laporan Pengeluaran</h2>
            </div>
            <div class="col-md-6 text-end">
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs">
                  ...
                  <span class="active">Laporan Pengeluaran</span>
                </div>
              </nav>
            </div>
          </div>
      ...
      <div class="col-lg-10">
        ...
        <div class="flex-grow-1 table-responsive">
          <table class="table table-bordered m-0 text-center align-middle h-100">
            ...
            <tbody>
              @forelse ($laporan as $index => $laporanpengeluaran)
              <tr>
                <td>{{ $laporan->firstItem() + $index }}</td>
                <td>{{ \Carbon\Carbon::parse($laporanpengeluaran->tanggal)->translatedFormat('d F Y') }}</td>
                <td>{{ $laporanpengeluaran->keterangan }}</td>
                <td>Rp {{ number_format($laporanpengeluaran->nominal, 0, ',', '.') }}</td>
              </tr>
              @empty
              <tr>
