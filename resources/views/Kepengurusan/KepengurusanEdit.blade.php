    ...
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <form id="formKepengurusanEdit" action="{{ route('kepengurusan.update', $kepengurusan->id_kepengurusan) }}" method="POST" enctype="multipart/form-data" class="row g-4 needs-validation">
                ...
                <div class="col-md-6">
                    <div class="form-floating form-floating-outline">
                        <input type="text" id="pendidikan" name="pendidikan" class="form-control" 
                            ...
                            value="{{ old('pendidikan', $kepengurusan->pendidikan) }}">
                ...
                <div class="col-md-12">
                    <div class="form-floating form-floating-outline">
                        <textarea id="profil_singkat" name="profil_singkat" class="form-control" 
                                placeholder="Tulis profil singkat" 
                                style="height: 120px;">{{ old('profil_singkat', $kepengurusan->profil_singkat) }}</textarea>
