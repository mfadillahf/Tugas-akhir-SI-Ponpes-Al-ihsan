    ...
    <footer id="footer" class="footer layer-overlay overlay-dark-9" data-tm-bg-img="images/bg/bg2.jpg">
        ...
        <div class="container pt-90 pb-60">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                ...
                <div class="thumb">
                    <img alt="Logo" src="{{ asset('LandingPage/studypress/images/logo-wide-white.png')}}">
                </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                ...
                <div class="latest-posts">
                    ...
                    <a class="post-thumb" href="#"><img src="{{ asset('LandingPage/studypress/https://placehold.it/75x75')}}" alt=""></a>
