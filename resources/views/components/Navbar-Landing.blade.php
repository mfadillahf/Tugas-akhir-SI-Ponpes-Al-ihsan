    <header id="header" class="header header-layout-type-header-2rows">
        <div class="header-top bg-lightest">
        <div class="container">
            <div class="row">
        ...
        <div class="header-nav-wrapper navbar-scrolltofixed">
            <div class="menuzord-container header-nav-container bg-lighter">
            <div class="container position-relative">
                <div class="row header-nav-col-row">
                <div class="col-sm-auto align-self-center">
                    <a class="menuzord-brand site-brand" href="{{ asset('LandingPage/studypress/index-mp-layout1.html')}}">
                    <img class="logo-default logo-1x" src="{{ asset('LandingPage/studypress/images/logo-wide-white.png')}}" alt="Logo">
                    <img class="logo-default logo-2x retina" src="{{ asset('LandingPage/studypress/images/logo-wide-white@2x.png')}}" alt="Logo">
                    </a>
                </div>
                            ...
                            <div class="megamenu-row">
                                <div  class="col3">
                                    ...
                                    <li class="menu-item">
                                        ...
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout1.html')}}">index Multipage Layout1</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout2.html')}}">index Multipage Layout2</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout3.html')}}">index Multipage Layout3</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout4.html')}}">index Multipage Layout4</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout5.html')}}">index Multipage Layout5</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout6.html')}}">index Multipage Layout6</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout7.html')}}">index Multipage Layout7</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout8.html')}}">index Multipage Layout8</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout9.html')}}">index Multipage Layout9</a></li>
                                        <li><a href="{{ asset('LandingPage/studypress/index-mp-layout10.htm')}}l">index Multipage Layout10</a></li>
                                        </ul>
                                    </li>
                                    </ul>
                                </div>
