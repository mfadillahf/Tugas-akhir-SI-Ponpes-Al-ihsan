        ...
        <div class="container-fluid p-0">
            ...
            <div class="col">
                ...
                <rs-module id="rev_slider_1_1" style="display:none;" data-version="6.1.7">
                    <rs-slides>
                    <rs-slide data-key="rs-47" data-title="Slide 1" data-thumb="{{ asset('studypress/images/bg/ponpes.jpg')}}" data-anim="ei:d;eo:d;s:d;r:0;t:slotslide-horizontal;sl:d;">
                        <img src="{{ asset('studypress/images/bg/ponpes.jpg')}}" title="bg3" width="1920" height="1280" data-parallax="off" class="rev-slidebg" data-no-retina>
                        <!--
                        -->
                        <rs-layer
                        ...
                        <rs-layer
                            ...
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:l,l,l,c;xo:55px,50px,55px,0;yo:226px,212px,179px,153px;"
                            data-text="w:normal;s:90,70,60,42;l:100,80,70,60;ls:0px,0px,0px,0px;fw:700;a:left,left,left,center;"
                    ...
                    <rs-slide data-key="rs-48" data-title="Slide 1" data-thumb="{{ asset('studypress/images/bg/ponpes2.jpg')}}" data-anim="ei:d;eo:d;s:d;r:0;t:slotslide-horizontal;sl:d;">
                        <img src="{{ asset('studypress/images/bg/ponpes2.jpg')}}" title="bg2" width="1920" height="1280" data-parallax="off" class="rev-slidebg" data-no-retina>
                        <!--
                        -->
                        <rs-layer
                        id="slider-10-slide-48-layer-1"
                        data-type="text"
                        data-rsp_ch="on"
                        ...
                        -->
                        <rs-layer
                        id="slider-10-slide-48-layer-2"
                        data-type="text"
                        data-rsp_ch="on"
                        data-xy="x:c,c,c,c;yo:226px,212px,179px,153px;"
                        data-text="w:normal;s:90,70,60,42;l:100,80,70,60;ls:0px,0px,0px,0px;fw:700;a:center,center,center,center;"
                        data-frame_1="st:300;sp:1000;sR:310;"
                        data-frame_999="o:0;st:w;sR:7690;"
                        style="z-index:11;text-transform:uppercase;"
                        >Ponpes Al-Ihsan 
                    ...
                    <rs-slide data-key="rs-49" data-title="Slide 1" data-thumb="{{ asset('studypress/images/bg/bg3.jpg')}}" data-anim="ei:d;eo:d;s:d;r:0;t:slotslide-horizontal;sl:d;">
                        <img src="{{ asset('studypress/images/bg/bg2.jpg')}}" title="bg4" width="1920" height="1280" data-parallax="off" class="rev-slidebg" data-no-retina>
                        <!--
                        -->
                        <rs-layer
                        ...
                        data-frame_999="o:0;st:w;sR:8700;"
                        style="z-index:9;"
                        >lways <br>try to achieve our client's trust and satisfaction.
                        </rs-layer>
                        <!--
                        -->
                        <rs-layer
                            id="slider-10-slide-49-layer-2"
                            data-type="text"
                            data-rsp_ch="on"
                            data-xy="x:r,r,r,c;xo:55px,50px,55px,0;yo:226px,212px,179px,153px;"
                            data-text="w:normal;s:90,70,60,42;l:100,80,70,60;ls:0px,0px,0px,0px;fw:700;a:right,right,right,center;"
                            data-frame_1="st:300;sp:1000;sR:310;"
                            data-frame_999="o:0;st:w;sR:7690;"
                            style="z-index:11;text-transform:uppercase;"
                        >
